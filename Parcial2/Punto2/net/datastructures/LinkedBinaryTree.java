...
public boolean isSubtree(LinkedBinaryTree<E> t) {
  ...
  int i = 0;
  for (Position<E> pos : this.inorder()) {
    list.add(i, pos.getElement());
    i++;
  }
  System.out.println(list);

  i = 0;
  for (Position<E> pos : t.inorder()) {
    list1.add(i, pos.getElement());
    i++;
  }
  ...
  i = 0;
  for (Position<E> pos : t.postorder()) {
    list3.add(i, pos.getElement());
    i++;
  }
